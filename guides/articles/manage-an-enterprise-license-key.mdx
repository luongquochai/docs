...
description: Learn how to manage your API Lab Enterprise Edition license key.
---

This guide provides step-by-step instructions for managing your API Lab Enterprise Edition license key. If you plan to self-host the API Lab Enterprise Edition, you must obtain a License Key.

## Creating an Account

To initiate the process, you need to create an account on the API Lab Enterprise Dashboard.
...
Upon successful payment, your License Key will be available on the dashboard. Copy it and paste it into the `.env` file in your project's root directory. You can now start utilizing API Lab Enterprise Edition.
...
For more information on self-hosting API Lab Enterprise Edition, consult the guide on [Self-Hosting API Lab Enterprise Edition](/documentation/self-host/enterprise-edition/getting-started).
