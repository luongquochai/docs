...
An environment allows you to group together a set of variable data. You can reference the variable data you define in an environment throughout API Lab when sending requests or using scripts.
...
You can also create and delete environment variables using scripts by using the `pm` object..

```javascript
pm.environment.set("variable", "value"); // Creates an environment variable 
pm.environment.unset("variable"); // Deletes the environment variable
```
