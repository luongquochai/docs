---
sidebarTitle: Workspaces (coming soon)
title: Workspaces 
...
<Warning>Workspaces feature is coming soon. Please stay tuned for updates.</Warning>

Once you are logged into API Lab, you can toggle between multiple workspaces to organize your workflow.
...
To create a workspace, click on the **"+"** icon on the top right corner of the workspace switcher. Alternatively, you can also click on the "**Create new workspace**" button on the "[Profile](https://apilab.io/profile)" page under the "**Workspaces**" section.
...
To delete a workspace, click on the "**Delete**" button on the workspace you want to delete on the "[Profile](https://apilab.io/profile)" page under the "**Workspaces**" section.
