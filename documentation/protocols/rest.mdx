...
title: RESTful
description: RESTful API testing with API Lab.
---

## Platform

API Lab has a built-in REST platform that can be used to execute REST API requests. The REST platform can be accessed by clicking on the `REST` tab in the menu.
...
- **Scenarios** - The REST platform supports generating scenarios for your API requests using AI.
...
API Lab's REST API platform provides you with a fast and seamless experience to test and debug your API endpoints.
...
API Lab also provides the capability to run `Tests` on the responses you receive.
...
- [Scenarios with AI](/documentation/features/scenarios)
