...
API Lab helps you to organize your API requests with collections. You can create collections and add requests to them to share with your team or to use later. You can also import and export collections from API Lab, OpenAPI, and Postman.
...
You can import and export collections from API Lab, OpenAPI, and Postman.
...
At the collection level, you can configure *`(coming soon)`*:
