...
title: Widgets
description: Embed API Lab in your website.
---

Widgets are small, interactive components that can be embedded in HTML pages to provide a seamless experience for your audience. API Lab offers three types of widgets: links, buttons, and embeds.
...
Embeds are the most advanced type of widget. They are a mini version of API Lab that can be embedded in an HTML page, enabling your audience to interact seamlessly with your API request. You can customize the embed's appearance and behavior to suit your needs.
