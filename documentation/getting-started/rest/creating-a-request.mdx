...
description: Learn how to create a request in API Lab.
---

The RESTful protocol is the default protocol that is active when you open API Lab. API Lab allows you to make API requests and examine the responses.
