...
<Info>Cookies support is only available in the [API Lab Desktop App](/documentation/clients/desktop).</Info>

API Lab Cookie Manager enables you to add, edit, and remove cookies for a domain. You can also send a cookie with a request.
...
When you send a request to a domain for which you've specified a cookie, API Lab will automatically include it as part of the request.
