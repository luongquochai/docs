...
title: RESTful API testing with API Lab
description: Learn how to use API Lab to test your RESTful APIs.
---

Representational State Transfer (REST) APIs are a core part of communication between a web/mobile client and a server. The majority of web-based applications depend on REST APIs to fetch and modify data thus separating the data processing part from the front-end. API Lab provides a fast and intuitive platform to develop and test REST APIs making it easier for developers worldwide to work efficiently.
...
REST APIs also support HTTP methods to do operations on data. API Lab supports the following methods out of the box.
...
## Using API Lab to test your REST APIs

API Lab provides you with a minimal yet robust platform to test your REST APIs. The REST platform is the default platform you see when you open API Lab.
...
```
https://app-apilab.viettel.io
```

### Locally served APIs

If you are planning to use API Lab to test your locally served APIs, it is recommended that you install the API Lab Browser Extension. Once installed, switch the interceptor on API Lab to Browser Extension from the settings page or bottom bar to add support for [localhost](http://localhost) protocols.
...
API Lab has support for various types of authentication mechanisms such as Basic Auth, Bearer Token, OAuth 2.0, and API Key. You can configure this using the Authorization tab on the request section of API Lab.

These are just a few of the amazing set of features that API Lab provides you to make your life easier as a developer. In addition to this, API Lab supports features such as collections to save your requests, pre-requests to add dynamic behavior to your requests and so much more.
