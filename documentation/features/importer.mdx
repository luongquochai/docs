...
title: Importer
description: Migrate your data from other tools into API Lab.
---

Import data from other tools into API Lab. You can import data from the following tools:
...
{/* <Note> The size limit for importing collections varies by API Lab edition. In **API Lab Cloud**, you can import collections up to **10 MB**, while **Self-Hosted editions** allow imports of up to **50 MB**. </Note> */}
{/* 
## Import from API Lab

1. Export your API Lab collection/environment to a JSON file.
2. Open API Lab and click on the "**Import**" button on the collection/environment section.
3. Click on the "**Import from API Lab**" tab.
...
1. Open API Lab and click on the "**Import**" button on the collection section.
...
There are two ways to import OpenAPI collections into API Lab:

### 1. Import from File
1. Export your OpenAPI specification to a JSON file.
2. Open API Lab and click on the "**Import**" button on the collection section.
...
## Import from other services *`(coming soon)`*
...
### Import from cURL *`(coming soon)`*

You can import cURL commands into API Lab in the following ways:

- **Copy and paste**: Copy and paste the cURL command into the API Lab URL bar.
