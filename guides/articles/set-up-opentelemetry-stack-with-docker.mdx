...
This guide will help you set up the **OpenTelemetry Collector** on your own server and connect it with **API Lab**.

API Lab will send telemetry data (traces and metrics) to your **OpenTelemetry Collector** instance. From the **API Lab Admin Dashboard**, you can easily configure the connection to your deployed Collector.
...
1. **API Lab** sends telemetry data to your **OpenTelemetry Collector**.
...
<AccordionGroup>
    ...
    <Accordion title="Step 6: Connect API Lab">
        From the **API Lab Admin Dashboard**, configure the OpenTelemetry Collector endpoint (**HTTP**).
    </Accordion>
</AccordionGroup>

Once connected, API Lab will begin sending telemetry data, which you can observe in **Jaeger**, **Prometheus**, and **Grafana**.
