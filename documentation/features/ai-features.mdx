...
<Warning> These AI features are currently in the `alpha` stage and are exclusively available on [API Lab Cloud](https://app.apilab.work) and our [Desktop app](https://hoppscotch.com/download). They are **NOT** supported in the Self-Hosted Edition at this time. </Warning>
