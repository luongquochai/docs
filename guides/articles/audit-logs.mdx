---
sidebarTitle: Audit Logs in API Lab
title: Audit Logs in API Lab
description: Learn about the audit logs in API Lab Enterprise.
---

In Enterprise API Lab, a record of all actions taken on the platform is saved which can be used to know what events happened, who performed them, and when they occurred. With the information present users may be able to draw insights related to the platform.
